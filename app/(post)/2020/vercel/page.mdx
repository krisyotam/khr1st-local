...
If you’re creating a modern frontend nothing matters more than great site performance for the user. [Google’s Lighthouse score](https://x.com/krisyotam/status/1252312827131342848), for example, is measuring your frontend performance across multiple dials that are going to greatly influence your SEO ranking.
