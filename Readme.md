...
This is the blog that powers `laelyotam.com`, built on
[next.js](https://nextjs.org/) and
deployed to the cloud via [Vercel](https://vercel.com).

this blog displays a localized clone of [khr1st.com](https://khr1st.vercel.app) for longer form demonstrative post.
